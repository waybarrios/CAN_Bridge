...
void loop()
{
  ...
  while(1)  // Endless loop
  {
    ...
    for(cPort = 0; cPort <= 1; cPort++)
    {
      ...
      // ---------
       // Serial.print("something received D:");
        //if(cPort == 0){
         // cTxPort = 1;    
        ...
        {
          //if(cPort == CAN_DataMapping[nIndex].cReceivingPort && lMsgID == CAN_DataMapping[nIndex].lReceivingMsgID) {
          if(1){
            Serial.println("something received2");
            cTxPort = 0;
